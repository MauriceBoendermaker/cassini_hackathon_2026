...
export function IOSInstallBanner() {
  const { installVisible, hideInstall, triggerInstall, nativeInstallReady } = useAlert();
  ...
  return (
    <div className="ios-install" role="dialog" aria-label="Install Aegis">
      ...
      <div className="ii-actions">
        ...
        <button className="cta" onClick={handleInstall}>
          {nativeInstallReady ? "Install" : "Got it"}
        </button>
      </div>
    </div>
  );
